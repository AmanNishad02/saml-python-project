...
def saml_login():
    if request.method == 'GET':
        ...
        okta_sso_url = "https://dev-60700936.okta.com/app/dev-60700936_luxrentals20_1/exkgishgm0s9mLrrA5d7/sso/saml"
...
def signout():
    if request.method == 'POST':
        ...
        return redirect('https://dev-60700936.okta.com/login/signout')
    else:
        return redirect('/')